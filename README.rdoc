...
My List of Tasks:
For no seeds, feed notifications count, search for tags when no tags are present


Recruiter side 
- fix routing for posting jobs
- notifications for liked jobs
- maybe applicants that have liked recruiter's posting get added to string that for recruiter's
